...
namespace SalesWebMvc.Data
{
    ...
    {
        //toda vez que ocorrer uma população de dados no banco, ele vai ter que receber o contexto do banco, ou seja, onde.
        ...
        public void Seed()
        {
            //testa se existe algum registro na tabela Department
            ...
            Seller s3 = new Seller(3, "Alex Silva", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Bobchely", "martha@gmail.com", new DateTime(1993, 11, 29), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Duck", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Mei Mei", "mei@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
